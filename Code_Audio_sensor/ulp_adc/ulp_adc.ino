/*
  Helpfull Hallway
  Tuur Baele \\Pieter De Block \\Rijad  \v{S}ehovi\'{c} \\ Thomas Wauters
  Main application 
*/
#include "esp_sleep.h"
...
gpio_num_t ulp_27 = GPIO_NUM_27;//Led status output
gpio_num_t ulp_13 = GPIO_NUM_13;
//but measures on GPIO34!!!
...
void setup() {
  ...
  if (cause != ESP_SLEEP_WAKEUP_ULP) {
    ...
    // ***** HERE THERE CAN BE THE CAMERA MEASUREMENTS AND TRANSMISSION *****
...
static void init_ulp_program()
{
  ...
  adc1_ulp_enable();
  ulp_low_threshold = 0 ;  //0 volt
  ulp_high_threshold = 1 * (4095 / 3.3);   // 1 volts
